...
import { space, typography, layout, variant as variant$1, background as background$1, border, position, flexbox, grid, color } from 'styled-system';
...
var CakeIcon = styled.img(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n  width: 24px;\n  margin-right: 8px;\n"], ["\n  width: 24px;\n  margin-right: 8px;\n"])));
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://dexscreener.com/astar/0x10d0e3ef75a94027b9bd08497acf028566e87a1a", target: "_blank" },
        React__default.createElement(CakeIcon, { src: logoImg }),
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default.createElement(Flex, { order: [2, null, 1], alignItems: "center", justifyContent: "space-between" },
                    React__default.createElement(ThemeSwitcher$1, { isDark: isDark, toggleTheme: toggleTheme }),
                    React__default.createElement(StyledSocialLinks, { order: [2], ml: "48px" })),
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://ags.finance/swap?outputCurrency=" + CAKE.address, target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$24, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var LogoIcon = styled.img(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  height: 32px;\n  width: auto;\n"], ["\n  height: 32px;\n  width: auto;\n"])));
var LogoWithTextIcon = styled.div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  width: auto;\n  display: flex;\n  align-items: center;\n  span {\n    font-size: 24px;\n    margin-left: 8px;\n    font-family: 'Montserrat'\n  }\n"], ["\n  width: auto;\n  display: flex;\n  align-items: center;\n  span {\n    font-size: 24px;\n    margin-left: 8px;\n    font-family: 'Montserrat'\n  }\n"])));
...
var CustomWarning = styled(Flex)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  background: ", ";\n  padding: 10px 15px;\n"], ["\n  background: ", ";\n  padding: 10px 15px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.warning;
});
    ...
    return (React__default.createElement(Wrapper, null,
        React__default.createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default.createElement(Flex, { alignItems: "center" },
                ...
                " ",
                userMenu)),
        React__default.createElement(CustomWarning, { mt: "57px", alignItems: "start", px: 20, justifyContent: "center", flexDirection: "column" }, !isMobile ? (React__default.createElement(CustomWarning, { maxWidth: 1000, flexDirection: "column", alignItems: "start" },
            React__default.createElement(Flex, { alignItems: "center", justifyContent: "center", mt: "10px" },
                React__default.createElement(Text, null, " Q1: How to migrate from Farmv1 to Farmv2?")),
            React__default.createElement(Flex, { alignItems: "start", justifyContent: "center", mt: "10px", flexDirection: "column" },
                React__default.createElement(Flex, null,
                    React__default.createElement(Text, { mr: "8px" }, " A1: Go to"),
                    " ",
                    React__default.createElement(Link, { href: "https://v1.ags.finance/farms" }, "Farmv1"),
                    React__default.createElement(Text, { ml: "8px" }, ", and unstake all lp tokens.")),
                React__default.createElement(Flex, { ml: "23px" },
                    React__default.createElement(Text, { mr: "8px" }, "Go to"),
                    " ",
                    React__default.createElement(Link, { href: "https://ags.finance/farms" }, "Farmv2"),
                    React__default.createElement(Text, { ml: "8px" }, ", and stake all lp tokens."))),
            React__default.createElement(Flex, { alignItems: "center", justifyContent: "center", mt: "10px" },
                React__default.createElement(Text, null, "Q2: How to exchange AGS v1 to AGS v2?")),
            React__default.createElement(Flex, { alignItems: "center", justifyContent: "center" },
                React__default.createElement(Text, { mr: "8px" }, "A2: Please"),
                " ",
                React__default.createElement(Link, { href: "https://ags.finance/newTokenExchange" }, "Exchange"),
                React__default.createElement(Text, { ml: "8px" }, "here old AGS token with new AGS token.")))) : (React__default.createElement(CustomWarning, { maxWidth: 500, flexDirection: "column", alignItems: "start" },
            React__default.createElement(Text, null, "How to migrate from Farmv1 to Farmv2?"),
            React__default.createElement(Text, null,
                React__default.createElement(Link, { href: "https://v1.ags.finance/farms" }, "- Go to Farmv1.")),
            React__default.createElement(Text, null, "- Unstake all LP tokens"),
            React__default.createElement(Text, null,
                React__default.createElement(Link, { href: "https://ags.finance/farms" }, "- Go to Farmv2.")),
            React__default.createElement(Text, null, "- Stake all LP tokens"),
            React__default.createElement(Text, { mt: "10px" }, "How to swap AGS v1 to AGS v2?"),
            React__default.createElement(Text, null,
                React__default.createElement(Link, { href: "https://ags.finance/newTokenExchange" }, "Go to here and Swap."))))),
        subLinks && React__default.createElement(SubMenuItems, { items: subLinks, activeItem: activeSubItem }),
